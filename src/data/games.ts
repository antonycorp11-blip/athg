...
export const games: Game[] = [
  ...
  },
  {
    id: 'crazyblood',
    slug: 'crazyblood',
    previousSlugs: ['hemofazenda-incremental', 'hemofarm-incremental'],
    title: 'CrazyBlood',
    tagline: 'A fazenda nunca dorme.',
    shortDescription: 'Incremental vampírico: comece com um humano num cercado e termine com um império industrial de sangue.',
    description:
      'Compre humanos, colete sangue, automatize com vampiros coletores, feche contratos com clientes exigentes e veja sua propriedade crescer de um cercado miserável a um complexo vampírico. Quando a linhagem estagnar, funde uma Nova Linhagem e recomece muito mais forte. Em desenvolvimento pela ATHG.',
    gameUrl: 'https://crazyblood.antonycorp11.workers.dev/',
    hosting: 'external',
    categories: ['incremental', 'gerenciamento'],
    tags: ['Vampiros', 'Idle', 'Automação', 'Prestígio'],
    featured: false,
    original: true,
    status: 'coming-soon',
    adminPreview: true,
    ...
    orientation: 'any',
    instructions: [
      'Toque no tanque para coletar o sangue e venda para ganhar ouro.',
      'Compre humanos e expanda a propriedade; a cada marco de população a produção dobra.',
      'Contrate a Coleta Automática e a Carroça de Entrega para a fazenda trabalhar sozinha.',
      'Quando a produção estagnar, funde uma Nova Linhagem no Legado para ganhar Essência Ancestral.',
    ],
    screenshots: [],
