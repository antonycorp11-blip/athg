...
export const achievements: Achievement[] = [
  ...
  { id: 'hemofazenda-first-harvest', scope: 'hemofazenda', name: 'Primeira coleta', description: 'Faça sua primeira coleta de sangue.', icon: 'droplet', rarity: 'common', xp: 25 },
  { id: 'hemofazenda-expansion', scope: 'hemofazenda', name: 'Sede de expansão', description: 'Expanda a fazenda pela primeira vez.', icon: 'sprout', rarity: 'rare', xp: 75 },
  { id: 'hemofazenda-empire', scope: 'hemofazenda', name: 'Império noturno', description: 'Mantenha 10 estruturas funcionando ao mesmo tempo.', icon: 'castle', rarity: 'epic', xp: 150 },
  { id: 'hemofazenda-eternal-night', scope: 'hemofazenda', name: 'Noite eterna', description: 'Um segredo guardado pelos mais antigos.', icon: 'moon', rarity: 'legendary', xp: 300, hidden: true },
